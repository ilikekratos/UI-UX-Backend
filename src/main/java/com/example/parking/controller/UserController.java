...
import com.example.parking.dtos.MockDTO;
...
public class UserController {
    ...
    public ResponseEntity<String> token(@RequestBody MockDTO mockDTO){
        logger.info(mockDTO.getToken());
        logger.info(String.valueOf(JwtConfig.verifyToken(mockDTO.getToken())));
